...
### 3.5. no-useless-default-assignment
...
- `packages/rule-engine/src/rules/built-in/metadata-rules.ts`
- `packages/rule-engine/src/rules/built-in/text-rules.ts`
