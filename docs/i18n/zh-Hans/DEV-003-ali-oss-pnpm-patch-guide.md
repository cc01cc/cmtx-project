---
title: DEV-003 - 使用 pnpm patch 修复 ali-oss 打包问题
category: dev-guide
sidebar_order: 3
lang: zh-Hans
---
...
## 3. 解决方案：使用 pnpm patch

### 3.1. 为什么选择 pnpm patch
...
### 7.1. pnpm patch vs patch-package
...
#### 7.2.1. 为什么补丁放在根目录（非 VS Code 扩展专用）
...
- [DEV-005-tsdown-dependency-bundling-guide.md](packages/vscode-extension/DEV-005-tsdown-dependency-bundling-guide.md) - tsdown 依赖打包指南
