...
### 10.4. CHANGELOG 与双轨模式

CMTX 采用 changeset/manual 双轨工作流。包归属清单、维护流程和格式标准详见 **[DEV-008 §1.2](./DEV-008-changelog_guide.md#12-双轨模式包清单)**。本文档不再重复定义。

## 11. 源码参考

Changesets 源码参考（位于项目本地的 changesets 依赖中）：
...
- [CHANGELOG 标准化指南](./DEV-008-changelog_guide.md)
