---
title: "@cmtx/markdown-it-presigned-url-adapter-nodejs"
category: guide
sidebar_order: 12
lang: zh-Hans
---
...
Node.js 适配器，为 `@cmtx/markdown-it-presigned-url` 插件接入云存储预签名 URL 生成。内置缓存管理，支持阿里云 OSS。
...
4. 未命中则通过 `AliyunOSSAdapter.getSignedUrl()` 生成预签名 URL
