---
title: "VS Code 扩展 - tsdown 依赖打包"
category: dev-guide
sidebar_order: 5
lang: zh-Hans
---

# DEV-005: tsdown 依赖打包与 vsce 集成指南
...
该问题通过 `pnpm patch` 在项目根目录 `patches/ali-oss.patch` 中修复。详见 [DEV-003-ali-oss-pnpm-patch-guide.md](../../DEV-003-ali-oss-pnpm-patch-guide.md)。
