---
title: "@cmtx/markdown-it-presigned-url"
category: guide
sidebar_order: 11
lang: zh-Hans
---
...
Markdown-it 预签名 URL 图片渲染插件。自动为私有云存储（OSS、S3、COS）的图片 URL 签名，可在 Markdown 中安全预览。
...
- [cmtx-vscode](../vscode-extension) - 使用此插件的 VS Code 扩展
