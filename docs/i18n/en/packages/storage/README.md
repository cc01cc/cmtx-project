...
Object storage adapters providing a unified `StorageAdapter` interface for
...
- **Unified interface** - `StorageAdapter` provides a consistent API across
  providers
...
- **Extensible** - Implement `StorageAdapter` to add support for any storage
  provider
