---
name: drawio
description: Create draw.io diagrams and exports. Use when user asks to draw flowcharts, architecture diagrams, wireframes, or mockups, or mentions .drawio files.
---
