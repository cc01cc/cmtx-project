...
describe('formatMarkdownImage', () => {
    it('应该生成 Markdown 图片链接', () => {
        const result = formatMarkdownImage({ src: 'https://example.com/image.png', alt: '描述' });
        expect(result).toBe('![描述](https://example.com/image.png)');
    });

    it('应该处理空 alt 文本', () => {
        const result = formatMarkdownImage({ src: 'https://example.com/image.png', alt: '' });
...
describe('formatHtmlImage', () => {
    it('应该生成 HTML img 标签', () => {
        const result = formatHtmlImage({ src: 'https://example.com/image.png', alt: '描述' });
    ...
    it('应该处理空 alt', () => {
        const result = formatHtmlImage({ src: 'https://example.com/image.png', alt: '' });
