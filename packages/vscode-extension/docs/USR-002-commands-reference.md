...
| `CMTX: Upload all images` | [Explorer 右键] 上传 .md 文件中所有本地图片 |
| `CMTX: Upload images in markdowns` | [Explorer 右键] 上传目录内所有 .md 文件中的图片 |
| `CMTX: Safe delete unreferenced images` | [Explorer 右键] 扫描并删除目录内未被任何 .md 引用的孤立图片 |
