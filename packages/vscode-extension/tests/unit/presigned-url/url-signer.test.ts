    ...
    describe('初始化', () => {
        ...
        it('should use default expire time (600s) when not specified', () => {
            const config: PresignedUrlConfig = {
                ...
                maxRetryCount: 3,
                providerConfigs: [PROVIDER_CONFIG_FIXTURES.aliyunComplete],
            };
            urlSigner = new UrlSigner(config, mockCacheManager as unknown as UrlCacheManager);
        ...
        it('should skip providers without domain', () => {
            const config: PresignedUrlConfig = {
                ...
                maxRetryCount: 3,
                providerConfigs: [
                    PROVIDER_CONFIG_FIXTURES.missingDomain,
                    PROVIDER_CONFIG_FIXTURES.aliyunComplete,
                ],
            };
            urlSigner = new UrlSigner(config, mockCacheManager as unknown as UrlCacheManager);
    ...
    describe('signUrl - 签名主流程', () => {
        ...
        it('should return original URL on unsupported provider', async () => {
            const config: PresignedUrlConfig = {
                ...
                expire: 600,
                maxRetryCount: 3,
                providerConfigs: [PROVIDER_CONFIG_FIXTURES.tencent],
            };
            urlSigner = new UrlSigner(config, mockCacheManager as unknown as UrlCacheManager);
            mockCacheManager.get.mockReturnValue(null);
    ...
    describe('其他提供商支持', () => {
        ...
        it('should return original URL for aws (not implemented)', async () => {
            const config: PresignedUrlConfig = {
                ...
                expire: 600,
                maxRetryCount: 3,
                providerConfigs: [PROVIDER_CONFIG_FIXTURES.aws],
            };
            urlSigner = new UrlSigner(config, mockCacheManager as unknown as UrlCacheManager);
            mockCacheManager.get.mockReturnValue(null);
    ...
    describe('凭据合并逻辑', () => {
        ...
        it('should handle missing credentials (empty string)', async () => {
            const config: PresignedUrlConfig = {
                ...
                expire: 600,
                maxRetryCount: 3,
                providerConfigs: [PROVIDER_CONFIG_FIXTURES.aliyunMinimal],
            };
            urlSigner = new UrlSigner(config, mockCacheManager as unknown as UrlCacheManager);
            mockCacheManager.get.mockReturnValue(null);
