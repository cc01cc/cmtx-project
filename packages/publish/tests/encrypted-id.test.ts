...
describe('IdGenerator', () => {
    ...
    describe('encryptFF1', () => {
        ...
        it('should add checksum when withChecksum is true', () => {
            const plaintext = 'ABC123';
            const id = generator.encryptFF1(plaintext, TEST_KEY, { withChecksum: true });
    ...
    describe('decryptFF1', () => {
        ...
        it('should decrypt with checksum', () => {
            ...
            const id = generator.encryptFF1(original, TEST_KEY, { withChecksum: true });
            const decrypted = generator.decryptFF1(id, TEST_KEY, { withChecksum: true });
    ...
    describe('validateEncryptedId', () => {
        it('should validate encrypted ID', () => {
            ...
            const validation = generator.validateEncryptedId(id, { encryptionKey: TEST_KEY });

            expect(validation.valid).toBe(true);
        });

        it('should validate with checksum', () => {
            const id = generator.encryptFF1('ABC123', TEST_KEY, { withChecksum: true });
    ...
    describe("generate('ff1', ...)", () => {
        it('should support ff1 strategy', () => {
            const id = generator.generate('ff1', 'ABC123', { encryptionKey: TEST_KEY });
            expect(id.length).toBe(6);
        });
